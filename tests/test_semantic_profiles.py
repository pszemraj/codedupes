...
def test_search_threshold_is_looser_than_duplicate_threshold() -> None:
    ...
    assert get_default_search_threshold("embeddinggemma-300m") == 0.54
...
def test_language_gate_lookup_builtin_fallback_and_generic() -> None:
    ...
    assert get_semantic_threshold_for_language("embeddinggemma-300m", "typescript") == 0.87
...
def test_arbitrary_local_directory_infers_embeddinggemma_from_config(tmp_path: Path) -> None:
    ...
    assert profile.default_search_threshold == 0.54
